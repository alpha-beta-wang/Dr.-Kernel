...
GATE1_ENABLED=${GATE1_ENABLED:-${ENABLE_TWO_GATE_FILTER}}
GATE2_ENABLED=${GATE2_ENABLED:-${ENABLE_TWO_GATE_FILTER}}
...
run_training() {
  ...
  PYTHONUNBUFFERED=1 python -m kernel.main_kernel \
      ...
      data.truncation=$TRAIN_TRUNCATION \
      +data.validation_truncation=$VALIDATION_TRUNCATION \
